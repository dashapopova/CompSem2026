...
Эссе -- это итоговый элемент контроля, экзамен, другого экзамена не будет. Эссе весит 4 балла от итоговой оценки. Примерно 3-5 стр. Эссе без аналитического компонента не может получить оценку выше 6. 
...
1. до 1 июня  -- Вы определяетесь с темой, статьями, вписываете тему, идею, статьи и т.п. в [таблицу](https://docs.google.com/spreadsheets/d/12e1FOVfFTfMDXthu1XsSK1MkcpB_4hUJHfJ8If2xcsE/edit?usp=sharing) (вкладка "темы эссе лето 2026")

2. до 3 июня -- мы комментируем тему, статьи и т.п., консультация в конце предпоследней и последней пар  

3. **24 июня** -- дедлайн сдачи эссе, отправляйте эссе на оба наших адреса, после дедлайна работы не принимаются

**Требования и критерии оценивания**

На что мы обращаем внимание при оценивании эссе:
- содержательно: в тексте не должно быть ошибок интерпретации (т.е. при пересказе статей идеи авторов должны быть поняты и переданы корректно); текст должен быть самодостаточным (т.е. понятным читателю, не знакомому с обсуждаемыми статьями); помимо пересказа текст обязательно должен содержать аналитический компонент. Эссе без аналитического компонента не может получить оценку выше 6.
- по форме: текст должен более или менее укладываться в заданный объем (3-5 страниц); изложение должно быть ясным, четким, стилистически выдержанным.
- для проектных работ: к проектной работе должен быть приложен рабочий код; код должен сопровождаться полным и связным текстом, содержащим постановку задачи, подробное описание всего сделанного, содержательную интерпретацию результатов.

Примерная разбалловка:

4-6 -- в эссе ясно изложены идеи 2-3 статей, четкая структура эссе, использованы понятия, обсуждавшиеся в ходе курса;

7-8 баллов -- в эссе ставятся несколько вопросов по 2-3 статьям, эссе содержит анализ этих вопросов с привлечением как материала статей, так и собственного анализа, построенного на пройденном в ходе курса;

9-10 баллов  -- в эссе ставятся несколько вопросов по 2-3 статьям, эссе содержит глубокий анализ этих вопросов с привлечением как материала статей, так и собственного анализа, построенного на пройденном в ходе курса, анализ оригинален и выходит за рамки того, что обсуждалось в ходе курса, эссе выделяется на фоне остальных отличных эссе.
