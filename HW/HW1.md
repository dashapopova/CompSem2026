...
В этом задании мы будем создавать аналог системы CLICS на основе небольшого фрагмента онтологии WordNet, т.е. возьмем из WordNet данные о колексификациях значений (в этом случае - синсетов) и построим по ним взвешенный граф. Всё, что вам понадобится для работы с графами в рамках этого задания, можно найти [в этой тетрадке](https://github.com/dashapopova/CompSem2026/blob/main/CompSem_graphs_2026.ipynb).
